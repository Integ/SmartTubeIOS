...
struct PlaybackQualityTests {
    ...
    private func selectVariantTVOS(
        existing: URL?, existingIsH264: Bool,
        candidate: URL, candidateIsH264: Bool
    ) -> (URL, Bool) {
        if existing == nil {
    ...
    @Test func variantSelection_iOS_upgradesHEVCToH264() {
        ...
        let (selected, isH264) = selectVariantIOS(
    ...
    @Test func variantSelection_tvOS_keepsFirstVariant_whenFirstIsHEVC() {
        ...
        let (selected, isH264) = selectVariantTVOS(
            existing: hevcURL, existingIsH264: false,
            candidate: h264URL, candidateIsH264: true
        )
    ...
    private func makeFormat(height: Int, bitrate: Int? = nil) -> VideoFormat {
        ...
        return VideoFormat(
            label: "\(height)p", width: height * 16 / 9, height: height,
    ...
    @Test func qualitySelection_picksHighestAtOrBelowMax() {
        ...
        let hlsURLs: [Int: URL] = [
            2160: URL(string: "https://example.com/2160p.m3u8")!, 1440: variant1440,
            1080: URL(string: "https://example.com/1080p.m3u8")!,
        ]
    ...
    @Test func qualitySelection_noMatchAbove_fallsToNextLower() {
        ...
        let master = URL(string: "https://example.com/master.m3u8")!
        let hlsURLs: [Int: URL] = [
            1080: URL(string: "https://example.com/1080p.m3u8")!, 720: URL(string: "https://example.com/720p.m3u8")!,
        ]
    ...
    @Test func videoQuality_fromHeight_returnsNilForNonStandardHeight() {
        ...
        #expect(
            AppSettings.VideoQuality.from(height: 1088) == nil,
            "1088p is non-standard — must return nil, not silently map to a quality")
    ...
    @Test func adaptiveComposition_qualityCapFiltersHigherFormats() {
        ...
        let formats = [
            VideoFormat(
                label: "2160p", width: 3840, height: 2160, fps: 30, mimeType: "video/mp4", url: url2160,
                bitrate: 20_000_000),
            VideoFormat(
                label: "1080p", width: 1920, height: 1080, fps: 30, mimeType: "video/mp4", url: url1080,
                bitrate: 8_000_000),
        ]
    ...
    @Test func qualityCapVideoURL_prefersH264OverAV1_forAutoQuality() {
        let urlAV12160 = URL(string: "https://cdn.example.com/av1_2160p.mp4")!
        let urlH2641080 = URL(string: "https://cdn.example.com/h264_1080p.mp4")!
        let formats = [
            VideoFormat(
                label: "2160p", width: 3840, height: 2160, fps: 30,
                mimeType: "video/mp4; codecs=\"av01.0.12M.08\"",
                url: urlAV12160, bitrate: 20_000_000),
            VideoFormat(
                label: "1080p", width: 1920, height: 1080, fps: 30,
                mimeType: "video/mp4; codecs=\"avc1.640028\"",
                url: urlH2641080, bitrate: 8_000_000),
        ]
    ...
    @Test func qualityCapVideoURL_fallsBackToAV1WhenNoH264Available() {
        let urlAV12160 = URL(string: "https://cdn.example.com/av1_2160p.mp4")!
        let urlAV11080 = URL(string: "https://cdn.example.com/av1_1080p.mp4")!
        let formats = [
            VideoFormat(
                label: "2160p", width: 3840, height: 2160, fps: 30,
                mimeType: "video/mp4; codecs=\"av01.0.12M.08\"",
            ...
            VideoFormat(
                ...
                url: urlAV11080, bitrate: 8_000_000),
        ]
    ...
    @Test func deduplicatedVideoFormats_excludesVP9WebM() {
        ...
        let formats = [
            VideoFormat(
                label: "144p", width: 256, height: 144, fps: 15,
                mimeType: "video/mp4; codecs=\"avc1.4d400c\"",
                url: mp4URL, bitrate: 100_000),
            VideoFormat(
                label: "144p VP9", width: 256, height: 144, fps: 30,
    ...
    @Test func deduplicatedVideoFormats_showsBothH264AndAV1AtSameHeight() {
        ...
        let formats = [
            VideoFormat(
                ...
                url: mp4URL, bitrate: 100_000),
            VideoFormat(
                label: "144p", width: 256, height: 144, fps: 30,
    ...
    @Test func selectBestVideoFormat_ignoresNonMP4Formats() {
        ...
        let formats = [
            VideoFormat(
                label: "1080p HLS", width: 1920, height: 1080, fps: 30,
                mimeType: "application/x-mpegURL", url: hlsURL, bitrate: 8_000_000),
            VideoFormat(
                label: "1080p MP4", width: 1920, height: 1080, fps: 30,
                mimeType: "video/mp4; codecs=\"avc1.640028\"",
    ...
    @Test func hlsAssetHeaderKey_isCorrect() {
        ...
        #expect(
            key == "AVURLAssetHTTPHeaderFieldsKey",
